...
for f in proto_claude.go proto_gemini.go proto_qwen.go proto_openai.go proto_openai_variants.go hook_tools.go prelude.go jsonutil_llm.go proto_probe.go ason.go \
